                  ...
                  <div class="row">
                     <div class="col-lg-7 col-md-12 col-sm-12">
                        <div class="slider-content wow fadeInUp" data-wow-delay=".25s" data-wow-duration="2s" data-wow-iteration="1">
                           ...
                           <h1 class="hero-title">Shoes <span> Collaction </span></h1>
                           <p class="hero-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.</p>
                           <a href="#" class="slider-btn">Shop Now</a>
                        </div>
                     </div>
                     <div class="slider-img">
                        <img src="home_assets/images/slider-img.png" class="wow fadeInRight" data-wow-delay=".25s" data-wow-duration="1s"  data-wow-iteration="1" alt="">
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="client-Slider">
                  <div class="home-category">
                     <span><img src="home_assets/images/men.png" alt=""></span>
                     <h5>Men</h5>
                  </div>
                  <!--item-->
                  <div class="home-category">
                     <span><img src="home_assets/images/women.png" alt=""></span>
                     <h5>Women</h5>
                  </div>
                  <!--item-->
                  <div class="home-category">
                     <span><img src="home_assets/images/child.png" alt=""></span>
                     <h5>Children</h5>
                  </div>
                  <!--item-->
                  <div class="home-category">
                     <span><img src="home_assets/images/mobile.png" alt=""></span>
                     <h5>Mobile</h5>
                  </div>
                  <!--item-->
                  <div class="home-category">
                     <span><img src="home_assets/images/t-shirt.png" alt=""></span>
                     <h5>T-shirt</h5>
                  </div>
                  <!--item-->
                  <div class="home-category">
               ...
               <div class="product-slider">
                  <div class="new-collection-item">
                     <div class="new-collection-item-img">
                        ...
                        <img src="home_assets/images/t1.png" class="wow zoomIn" data-wow-delay=".25s" data-wow-duration="1s" data-wow-iteration="1" alt="">
                  ...
                  <div class="row">
                     <div class="col-lg-8 col-md-8 col-sm-8">
                        <div class="offer-banner-content">
                           <h3>Get 50% OFF</h3>
                           <h5> On Women Collection</h5>
                           <a href="#">Shop Now</a>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="offer-banner-img wow fadeInRight" data-wow-delay=".25s" data-wow-duration="1s"  data-wow-iteration="1">
                           <img src="home_assets/images/product-banner-img.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
               <div class="offer-banner">
                  <div class="row">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="offer-banner-img wow fadeInRight" data-wow-delay=".25s" data-wow-duration="1s"  data-wow-iteration="1">
                           <img src="home_assets/images/02-product-banner-img.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-lg-7 col-md-12 col-sm-12">
                  <div class="banner-content wow fadeInUp" data-wow-delay=".25s" data-wow-duration="2s" data-wow-iteration="1">
                     <h5>Get 50% Discount On</h5>
                     <h2>Best Price & Great Quality</h2>
                  ...
                  <div class="deal one-time">
                     <div class="product-offer">
                        <div class="product-offer-content">
                           <h6>Get 50% Discount On</h6>
                           <h2>Best Price & Great Quality</h2>
                           <p>Aenean imperdiet Etiam ultricies nisi vel augue Curabitur.</p>
                           <a href="#" class="buy-now">Shop Now</a>
                        </div>
                        <img src="home_assets/images/product-banner-img.png" alt="">
                     </div>
         ...
         <div class="container">
            ...
            <div class="row wow fadeInUp" data-wow-delay=".25s" data-wow-duration="1s" data-wow-iteration="1">
               ...
               <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="blog-card">
                     <div class="blog-img">
                        <img src="home_assets/images/blog-01.jpg" alt=""> <span class="date">25 May 2021</span>
                     </div>
                     <div class="blog-content">
                        ...
                        <h3><a href="#">Combined with a handful of model in fashion.</a></h3>
               ...
               <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="blog-card">
                     <div class="blog-img">
                        <img src="home_assets/images/blog-02.jpg" alt=""> <span class="date">25 May 2021</span>
                     </div>
                     <div class="blog-content">
                        <ul class="meta-tag">
                           <li><a href="#">By Admin</a>
               ...
               <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="blog-card">
                     <div class="blog-img">
                        <img src="home_assets/images/blog-03.jpg" alt=""> <span class="date">25 May 2021</span>
                     </div>
                     <div class="blog-content">
                        <ul class="meta-tag">
                           <li><a href="#">By Admin</a>
         ...
         <div class="container">
            <div class="row service-border wow fadeInUp" data-wow-delay=".25s" data-wow-duration="1s" data-wow-iteration="1">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-service-wrap">
                     <div class="thumb">
                        <img src="home_assets/images/02.png" alt="img">
                     </div>
                     <div class="wrap-details">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-service-wrap">
                     <div class="thumb">
                        <img src="home_assets/images/03.png" alt="img">
                     </div>
                     <div class="wrap-details">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-service-wrap">
                     <div class="thumb">
                        <img src="home_assets/images/04.png" alt="img">
                     </div>
                     <div class="wrap-details">
