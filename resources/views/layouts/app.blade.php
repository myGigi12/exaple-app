...
<!-- Mirrored from coderthemes.com/adminto/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Apr 2024 08:18:04 GMT -->
...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid"
            ...
            <ul class="list-unstyled topnav-menu float-end mb-0">
                            ...
                            <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                                ...
                                <div class="notification-list">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="d-flex align-items-start">
                                            <img class="d-flex me-2 rounded-circle"
                                                src="/admin_assets/images/users/user-2.jpg"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="d-flex align-items-start">
                                            <img class="d-flex me-2 rounded-circle"
                                                src="/admin_assets/images/users/user-5.jpg"
                                                alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img src="/admin_assets/images/users/user-1.jpg" class="img-fluid rounded-circle"
                                        alt="" />
                                </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="/admin_assets/images/users/user-4.jpg" class="img-fluid rounded-circle"
                                        alt="" />
                                </div>
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light"
                        ...
                        aria-expanded="false">
                        <img src="/admin_assets/images/users/user-1.jpg" alt="user-image" class="rounded-circle">
        ...
        <div class="left-side-menu">
            ...
            <div class="h-100" data-simplebar>
                ...
                <div class="user-box text-center">
                    ...
                    <img src="/admin_assets/images/users/user-1.jpg" alt="user-img" title="Mat Helme"
                ...
                <div class="tab-pane active" id="settings-tab" role="tabpanel">
                    ...
                    <div class="p-3">
                        ...
                        <div class="d-grid mt-4">
                            ...
                            <a href="../../../1.envato.market/admintoadmin.html" class="btn btn-danger mt-3"
    ...
    <script src="/admin_assets/libs/waypoints/lib/jquery.waypoints.min.js"></script>
    <script src="/admin_assets/libs/jquery.counterup/jquery.counterup.min.js"></script>
    <script src="/admin_assets/libs/feather-icons/feather.min.js"></script>

    <!-- knob plugin -->
    <script src="/admin_assets/libs/jquery-knob/jquery.knob.min.js"></script>

    <!--Morris Chart-->
    <script src="/admin_assets/libs/morris.js06/morris.min.js"></script>
...
<!-- Mirrored from coderthemes.com/adminto/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Apr 2024 08:19:46 GMT -->
